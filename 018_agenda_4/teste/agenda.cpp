...
void FONE::setOperadora(std::string operadora){
    this->operadora = operadora;
}

std::string FONE::getOperadora(){
...
// CONTATO_STAR
CONTATO_STAR::CONTATO_STAR(std::string nome, std::map<int, FONE> fones, bool star){
    this->setNome(nome);
    for (auto fone : fones)
        this->setFone(fone.second);
    this->star = star;
}